...
-- Presses K for reposition
Citizen.CreateThread(function()
    while true do
        Wait(0)
        if IsControlPressed(0, 311) and isDead then
...
function StartDeathTimer()
	...
	Citizen.CreateThread(function()
		...
		while earlySpawnTimer > 0 and isDead do
            ...
            SetTextOutline()
            BeginTextCommandDisplayText('STRING')
            AddTextComponentSubstringPlayerName(_U('reposition_send'))
            EndTextCommandDisplayText(0.440, 0.830)
		end
